(() => {
    ...
    const t = e(
        ...
        //     return e.verified
        //         ? e._e()
        //         : n("div", { staticClass: "note note-warning" }, [
        //               n("p", [
        //                   e._v(
        //                       "\n       saleh Your license is invalid, please contact support. If you didn't setup license code, please go to\n        "
        //                   ),
        //                   n("a", { attrs: { href: e.settingUrl } }, [
        //                       e._v("Settings"),
        //                   ]),
        //                   e._v(" to activate license!\n    "),
        //               ]),
        //           ]);
        // },
        [],
    ...
    const n = e(
        ...
        function () {
            var e = this,
                t = e.$createElement,
                n = e._self._c || t;
            return e.hasNewVersion
                ? n("div", { staticClass: "note note-warning" }, [
                      n("p", [
                          e._v(e._s(e.message) + ", please go to "),
                          n("a", { attrs: { href: e.settingUrl } }, [
                              e._v("System Updater"),
                          ]),
                          e._v(" to upgrade to the latest version!"),
                      ]),
                  ])
                : e._e();
        },
    ...
    "undefined" != typeof vueApp &&
        vueApp.booting(function (e) {
            e.component("verify-license-component", t),
                e.component("check-update-component", n);
        });
    var a = {},
        l = (function () {
            function e() {
                ...
                (r = [
                    {
                        ...
                        value: function (t, n, r, o) {
                            ...
                            if (!s.length || !s.hasClass("collapse")) {
                                ...
                                d.length && (r.predefined_range = d.val()),
                                    $.ajax({
                                        type: "GET",
                                        cache: !1,
                                        url: n,
