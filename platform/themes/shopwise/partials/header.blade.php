...
<body @if (BaseHelper::siteLanguageDirection() == 'rtl') dir="rtl" @endif>
    ...
    <header class="header_wrap">
                                ...
                                <ul class="header_list">
                                    @if (EcommerceHelper::isCompareEnabled())
                                        <li><a href="{{ route('public.compare') }}"><i
                                                    class="ti-control-shuffle"></i><span>{{ __('Compare') }}</span></a>
                                        </li>
                                    @endif
            ...
            <div class="container">
                <div class="nav_block">
                    <a class="navbar-brand" href="{{ route('public.index') }}">
                        <img class="logo_dark" src="{{ RvMedia::getImageUrl(theme_option('logo')) }}"
        ...
        <div
            class="bottom_header light_skin main_menu_uppercase bg_dark @if (url()->current() === route('public.index')) mb-4 @endif">
            <div class="container">
                <div class="row">
                        ...
                        @if (is_plugin_active('ecommerce'))
                            <div class="categories_wrap">
                                ...
                                <div id="navCatContent"
                                    class="@if (url()->current() === route('public.index') &&
                                            theme_option('collapsing_product_categories_on_homepage', 'no') == 'no') nav_cat @endif navbar collapse">
        ...
        @if (theme_option('enable_sticky_header', 'yes') == 'yes')
            <div
                class="bottom_header bottom_header_sticky light_skin main_menu_uppercase bg_dark fixed-top header_with_topbar d-none">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-4">
                            <a class="navbar-brand" href="{{ route('public.index') }}">
